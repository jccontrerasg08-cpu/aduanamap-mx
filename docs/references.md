...
| **Mapa mundial** — geometría por país | [topojson/world-atlas](https://github.com/topojson/world-atlas) · [datasets/geo-countries](https://github.com/datasets/geo-countries) · [georgique/world-geojson](https://github.com/georgique/world-geojson) (ver [ADR 0004](decisions/0004-world-map.md)) |
| Mapa — datos de país (ISO, nombre es/en, región) | [mledoze/countries](https://github.com/mledoze/countries) · [lukes/ISO-3166-Countries-with-Regional-Codes](https://github.com/lukes/ISO-3166-Countries-with-Regional-Codes) · [planetopendata/awesome-world](https://github.com/planetopendata/awesome-world) |
| Mapa — basemap sin lock-in / render / simplificar / a11y | [protomaps/basemaps](https://github.com/protomaps/basemaps) · [visgl/react-maplibre](https://github.com/visgl/react-maplibre) · [mbloch/mapshaper](https://github.com/mbloch/mapshaper) · [maplibre/awesome-maplibre](https://github.com/maplibre/awesome-maplibre) · [mapbox/mapbox-gl-accessibility](https://github.com/mapbox/mapbox-gl-accessibility) |
